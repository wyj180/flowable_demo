 ...
 * Flowable 入门案例一
 */
public class HelloWorld01 extends FlowableDemoApplicationTests {
    ...
    public void deploymentProcessDefinition() {
        Deployment deployment = repositoryService
                ...
                .addClasspathResource("process/MyProcess.bpmn")// 从classpath的资源中加载，一次只能加载一个文件
                .deploy();// 完成部署
    ...
    public void startProcessInstance() {
        //根据流程定义的key启动流程
        String processDefinitionKey = "MyFirstProcessKey";
